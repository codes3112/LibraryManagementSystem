...
namespace LibraryServices
{
    public class CheckoutService : ICheckout
    {
        ...
        public Checkout GetById(int checkoutId)
        {
            ...
            //this will return the first item where id matches
        ...
        {
            //remove any existing checkpouts on the item
        ...
        public void CheckOutItem(int assetId, int libraryCardId)
        {
            if (IsCheckedOut(assetId))
            {
                ...
                return;
                //Add the logic to handle feedback to the user; 
            }
            var item = _context.LibraryAssets
                .FirstOrDefault(a => a.Id == assetId);
        ...
        public string GetCurrentHoldPatronName(int holdId)
        {
            ...
            //if there is no hold the cardId will be null 
            //so to avoid NullPointer Exception we put NullPointer expression '?'
